    ...
    return (
        <div className="h-[600px] flex flex-col">
            <div className="mb-4 flex flex-col sm:flex-row gap-2">
                <button
                    onClick={downloadPDF}
                    className="flex-1 px-3 py-2 sm:px-4 sm:py-3 bg-green-600 text-white rounded-lg font-medium hover:bg-green-700 transition-colors flex items-center justify-center gap-1.5 sm:gap-2 text-sm sm:text-base"
                >
                ...
                <button
                    ...
                    className="flex-1 px-3 py-2 sm:px-4 sm:py-3 bg-green-500 text-white rounded-lg font-medium hover:bg-green-600 transition-colors flex items-center justify-center gap-1.5 sm:gap-2 text-sm sm:text-base"
                >
                ...
                <button
                    onClick={printResume}
                    className="flex-1 px-3 py-2 sm:px-4 sm:py-3 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors flex items-center justify-center gap-1.5 sm:gap-2 text-sm sm:text-base"
                >
                    <svg className="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
