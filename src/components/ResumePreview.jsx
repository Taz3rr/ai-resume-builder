    ...
    return (
        <div className="h-[600px] flex flex-col">
            <div className="mb-4 flex flex-col sm:flex-row gap-2">
                <button
                    onClick={downloadPDF}
                    className="flex-1 px-3 py-2 sm:px-4 sm:py-3 bg-blue-600/90 backdrop-blur-sm text-white rounded-lg font-medium hover:bg-blue-700 transition-colors flex items-center justify-center gap-1.5 sm:gap-2 text-sm sm:text-base shadow-lg"
                >
                    ...
                    <span className="truncate">{t.downloadPDF}</span>
                </button>
                <button
                    onClick={shareOnWhatsApp}
                    className="flex-1 px-3 py-2 sm:px-4 sm:py-3 bg-green-500/90 backdrop-blur-sm text-white rounded-lg font-medium hover:bg-green-600 transition-colors flex items-center justify-center gap-1.5 sm:gap-2 text-sm sm:text-base shadow-lg"
                >
                    ...
                    <span className="truncate">{t.whatsappShare}</span>
                </button>
                <button
                    onClick={printResume}
                    className="flex-1 px-3 py-2 sm:px-4 sm:py-3 bg-blue-500/90 backdrop-blur-sm text-white rounded-lg font-medium hover:bg-blue-600 transition-colors flex items-center justify-center gap-1.5 sm:gap-2 text-sm sm:text-base shadow-lg"
                >
                    <svg className="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z" />
                    </svg>
                    <span className="truncate">{t.printResume}</span>
                </button>
            </div>
